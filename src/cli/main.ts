...
function usage(): string {
  return `tado - Deterministic workflow engine for LLM orchestration

Usage:
  tado init    --workflow <path> [--base-dir <dir>] [--session <id>]
  tado next    --session <id>  [--base-dir <dir>] [--workflow <path>]
  tado report  --session <id>  [--base-dir <dir>] [--workflow <path>]
  tado status  --session <id>  [--base-dir <dir>]
...
Options:
  ...
  --base-dir <dir>    Base directory for session storage (default: tmp/tado)
